...
Partial Public Class Inicio
	...
	'''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
	'''</remarks>
	Protected WithEvents Buscador As Global.System.Web.UI.WebControls.Button
	...
	'''<summary>
	'''Control lblSinAlojamientos.
	'''</summary>
	'''<remarks>
	'''Campo generado automáticamente.
	'''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
	'''</remarks>
	Protected WithEvents lblSinAlojamientos As Global.System.Web.UI.WebControls.Label
